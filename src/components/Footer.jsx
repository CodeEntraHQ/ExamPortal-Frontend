...
export default function Footer() {
  return (
    <footer className="flex items-center justify-between px-8 h-16 bg-white/80 backdrop-blur-sm border-t border-indigo-50 shadow-lg shadow-indigo-100/10 z-10">
