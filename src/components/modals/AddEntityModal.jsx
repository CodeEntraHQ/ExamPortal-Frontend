...
export default function AddEntityModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      addSuccess('Entity created successfully!');
      handleClose();
      onSuccess(newEntity);
    } catch (error) {
      ...
      if (error.message.includes('already exists')) {
        ...
        addError('Failed to create entity. Please try again.');
      }
    } finally {
