    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (response.status === 'SUCCESS') {
          ...
          setLoginError(response.responseMsg === 'AUTHENTICATION_FAILED' 
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-background bg-opacity-40 backdrop-blur-[2px]">
      <div className="relative w-full max-w-lg p-1">
        ...
        <form 
          ...
          <h2 className="mb-4 text-4xl font-extrabold tracking-tight text-transparent bg-gradient-to-r from-primary to-indigo-600 bg-clip-text
            relative after:content-[''] after:absolute after:bottom-[-8px] after:left-0 after:w-16 after:h-1 after:bg-primary">Login</h2>
